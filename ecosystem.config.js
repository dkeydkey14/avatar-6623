module.exports = {
  apps: [
    {
      name: 'avata6623-down', // Tên ứng dụng hiển thị trong PM2
      ...
      max_memory_restart: '1G', // Tự động khởi động lại nếu sử dụng quá 1GB RAM
      env: {
        NODE_ENV: 'production', // Biến môi trường chạy ở chế độ production
        PORT: 8990 // Port để ứng dụng Next.js lắng nghe
      },
